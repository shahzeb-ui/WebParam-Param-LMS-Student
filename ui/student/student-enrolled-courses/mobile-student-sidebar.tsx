...
const StudentMobileSideBar = ({isOpen,toggleSidebar,}: StudentMobileProps): JSX.Element => {
  ...
  return (
    <div className={`${styles.sidebar} ${isOpen ? styles.open : ""}`} style={{ width:'100%', position:'absolute', bottom:'0 !important', left:'0 !important', right:'0 !important', top:'85px !important',zIndex:'1000'}}>
