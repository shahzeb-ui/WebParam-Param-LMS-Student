          ...
          <div className="col-lg-8" style={{ width:'100%', padding: '0 10px'}}>
            <div className="course-details-content">
              ...
              <div className="rbt-inner-onepage-navigation sticky-top mt--30">
                <nav className="mainmenu-nav onepagenav" style={{borderRadius:'8px'}}>
                  <ul className="mainmenu" style={{padding:'10px', borderRadius:'8px'}}>
                    <li className="">
              ...
              >
                <div className="rbt-course-feature-inner has-show-more-inner-content">
                  ...
                  <p>
                    ...
                    aperiam nemo nam tempora, dignissimos dicta excepturi ea quo
                    ipsum omnis maiores perferendis commodi voluptatum facere
                    vel vero. Praesentium quisquam iure veritatis, perferendis
                    adipisci sequi blanditiis quidem porro eligendi fugiat
                    facilis inventore amet delectus expedita deserunt ut
                    molestiae modi laudantium, quia tenetur animi natus ea.
                    Molestiae molestias ducimus pariatur et consectetur. Error
                    vero, eum soluta delectus necessitatibus eligendi numquam
                    hic at?
                  </p>
                </div>
              ...
              <div className="row g-5 align-items-end mb--40">
                <div className="col-lg-8 col-md-8 col-12">
                  <div className="section-title">
                    ...
                    <h4 className="title">
                      More Course By
                      <strong className="color-primary ms-3">Fred Guer</strong>
                    </h4>
                  </div>
                </div>
