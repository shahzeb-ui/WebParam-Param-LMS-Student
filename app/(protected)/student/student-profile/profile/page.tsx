  ...
  async function getUserProfile() {
    ...
    if (res?.data) {
      ...
      if (res.data.data.firstName && res.data.data.surname) {
        cookies.set(
          "username",
          `${res.data.data.firstName} ${res.data.data.surname}`
        );
      } else {
    ...
    if (event.target.files && event.target.files[0]) {
      ...
      try {
        const response = await axios.post(
          `${readUserData}/api/v1/Profile/UploadProfilePicture/${user?.data?.id}`,
          formData,
          {
            headers: {
          ...
          >
            <div className="rbt-form-group">
              ...
              <input
                ...
                name="date"
                value={
                  dateOfBirth == "0001-01-01" ? getTodayDate() : dateOfBirth
                }
                required
          ...
          <div className="col-lg-6 col-md-6 col-sm-6 col-12">
            <div className="filter-select rbt-modern-select rbt-form-group">
              ...
              >
                ...
                {codes &&
                  codes[4]?.codes?.map((item: any, index: number) => (
                    <option
                      key={index}
                      value={`${item.code}`}
                      className="text-dark"
