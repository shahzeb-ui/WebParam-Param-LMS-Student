  ...
  return (
    <>
      ...
      <div className="row mb-lg-8pt">
        <div className="rbt-review-wrapper rbt-shadow-box review-wrapper mt--30" id="review" data-aos="fade-up">
      ...
      <div className="row card-group-row mt-3">
        <div className="col-lg-6 col-md-12 card-group-row__col" data-aos="fade-up">
          <div className="rbt-review-wrapper rbt-shadow-box review-wrapper mt--10" id="review">
            <div className="col-lg-12 col-md-12 col-sm-6 col-12" data-aos="fade-up">
        ...
        <div className="col-lg-6 col-md-12 card-group-row__col mb-3" data-aos="fade-up">
          <LineChart />
        </div>

        <div className="col-lg-6 col-md-12 card card-group-row__col mb-3" data-aos="fade-up">
          <BarGraph />
        </div>

        <div className="col-lg-6 col-md-12 p-0 card-group-row__col" data-aos="fade-up">
          <DoubleLineGraph />
        </div>

        <div className="col-lg-6 col-md-12 p-3 card d-flex justify-content-center align-items-center card-group-row__col" data-aos="fade-up">
          <PieChart />
        </div>
      </div>
    </>
